...
class LightGCNDataset(DownloadableDataset):
    def __init__(self, dataset_name, batch_size=1024, featureless=True, download_urls=None, dataset_root_path=None):
    ...
    def process(self):
        ...
        data_generator = Data(path=data_dir, batch_size=self.batch_size)

        num_users, num_items = data_generator.n_users, data_generator.n_items
        n_train, n_test = data_generator.n_train, data_generator.n_test

        return num_users, num_items, n_train, n_test
